...
def read_data_get_chunksize(*args):
  """read_data_get_chunksize(struct ftdi_context ftdi) -> int"""
  return _ftdi1.read_data_get_chunksize(*args)

def write_data_get_chunksize(*args):
  """write_data_get_chunksize(struct ftdi_context ftdi) -> int"""
...
def get_latency_timer(*args):
  """get_latency_timer(struct ftdi_context ftdi) -> int"""
  return _ftdi1.get_latency_timer(*args)

def poll_modem_status(*args):
  """poll_modem_status(struct ftdi_context ftdi) -> int"""
  return _ftdi1.poll_modem_status(*args)

def get_eeprom_value(*args):
  """get_eeprom_value(struct ftdi_context ftdi, enum ftdi_eeprom_value value_name) -> int"""
  return _ftdi1.get_eeprom_value(*args)

def get_eeprom_buf(*args):
  """get_eeprom_buf(struct ftdi_context ftdi, unsigned char buf) -> int"""
...
class transfer_control(_object):
    ...
    def __init__(self): 
        """__init__(self) -> transfer_control"""
...
class FTDIProgressInfo(_object):
    ...
    def __init__(self): 
        """__init__(self) -> FTDIProgressInfo"""
...
def init(*args):
  """init(struct ftdi_context ftdi) -> int"""
  return _ftdi1.init(*args)

def new():
  """new() -> struct ftdi_context"""
  return _ftdi1.new()

def set_interface(*args):
  """set_interface(struct ftdi_context ftdi, enum ftdi_interface interface) -> int"""
  return _ftdi1.set_interface(*args)

def deinit(*args):
  """deinit(struct ftdi_context ftdi)"""
  return _ftdi1.deinit(*args)

def free(*args):
  """free(struct ftdi_context ftdi)"""
  return _ftdi1.free(*args)

def set_usbdev(*args):
  """set_usbdev(struct ftdi_context ftdi, struct libusb_device_handle usbdev)"""
  return _ftdi1.set_usbdev(*args)

def get_library_version():
  """get_library_version() -> struct ftdi_version_info"""
...
def list_free2(*args):
  """list_free2(struct ftdi_device_list devlist)"""
  return _ftdi1.list_free2(*args)

def eeprom_set_strings(*args):
  """
    eeprom_set_strings(struct ftdi_context ftdi, char manufacturer, char product, 
        char serial) -> int
    """
  return _ftdi1.eeprom_set_strings(*args)

def usb_open(*args):
  """usb_open(struct ftdi_context ftdi, int vendor, int product) -> int"""
  return _ftdi1.usb_open(*args)

def usb_open_desc(*args):
  """
    usb_open_desc(struct ftdi_context ftdi, int vendor, int product, 
        char description, char serial) -> int
    """
  return _ftdi1.usb_open_desc(*args)

def usb_open_desc_index(*args):
  """
    usb_open_desc_index(struct ftdi_context ftdi, int vendor, int product, 
        char description, char serial, unsigned int index) -> int
    """
  return _ftdi1.usb_open_desc_index(*args)

def usb_open_dev(*args):
  """usb_open_dev(struct ftdi_context ftdi, struct libusb_device dev) -> int"""
  return _ftdi1.usb_open_dev(*args)

def usb_open_string(*args):
  """usb_open_string(struct ftdi_context ftdi, char description) -> int"""
  return _ftdi1.usb_open_string(*args)

def usb_close(*args):
  """usb_close(struct ftdi_context ftdi) -> int"""
  return _ftdi1.usb_close(*args)

def usb_reset(*args):
  """usb_reset(struct ftdi_context ftdi) -> int"""
  return _ftdi1.usb_reset(*args)

def usb_purge_rx_buffer(*args):
  """usb_purge_rx_buffer(struct ftdi_context ftdi) -> int"""
  return _ftdi1.usb_purge_rx_buffer(*args)

def usb_purge_tx_buffer(*args):
  """usb_purge_tx_buffer(struct ftdi_context ftdi) -> int"""
  return _ftdi1.usb_purge_tx_buffer(*args)

def usb_purge_buffers(*args):
  """usb_purge_buffers(struct ftdi_context ftdi) -> int"""
  return _ftdi1.usb_purge_buffers(*args)

def set_baudrate(*args):
  """set_baudrate(struct ftdi_context ftdi, int baudrate) -> int"""
  return _ftdi1.set_baudrate(*args)

def set_line_property(*args):
  """
    set_line_property(struct ftdi_context ftdi, enum ftdi_bits_type bits, 
        enum ftdi_stopbits_type sbit, enum ftdi_parity_type parity) -> int
    """
  return _ftdi1.set_line_property(*args)

def set_line_property2(*args):
  """
    set_line_property2(struct ftdi_context ftdi, enum ftdi_bits_type bits, 
...
def read_data_set_chunksize(*args):
  """read_data_set_chunksize(struct ftdi_context ftdi, unsigned int chunksize) -> int"""
  return _ftdi1.read_data_set_chunksize(*args)

def write_data(*args):
  """write_data(struct ftdi_context ftdi, unsigned char buf, int size) -> int"""
  return _ftdi1.write_data(*args)

def write_data_set_chunksize(*args):
  """write_data_set_chunksize(struct ftdi_context ftdi, unsigned int chunksize) -> int"""
  return _ftdi1.write_data_set_chunksize(*args)

def readstream(*args):
  """
    readstream(struct ftdi_context ftdi, FTDIStreamCallback callback, 
        void userdata, int packetsPerTransfer, int numTransfers) -> int
    """
  return _ftdi1.readstream(*args)

def write_data_submit(*args):
  """write_data_submit(struct ftdi_context ftdi, unsigned char buf, int size) -> struct ftdi_transfer_control"""
  return _ftdi1.write_data_submit(*args)

def read_data_submit(*args):
  """read_data_submit(struct ftdi_context ftdi, unsigned char buf, int size) -> struct ftdi_transfer_control"""
  return _ftdi1.read_data_submit(*args)

def transfer_data_done(*args):
  """transfer_data_done(struct ftdi_transfer_control tc) -> int"""
  return _ftdi1.transfer_data_done(*args)

def set_bitmode(*args):
  """set_bitmode(struct ftdi_context ftdi, unsigned char bitmask, unsigned char mode) -> int"""
  return _ftdi1.set_bitmode(*args)

def disable_bitbang(*args):
  """disable_bitbang(struct ftdi_context ftdi) -> int"""
  return _ftdi1.disable_bitbang(*args)

def set_latency_timer(*args):
  """set_latency_timer(struct ftdi_context ftdi, unsigned char latency) -> int"""
  return _ftdi1.set_latency_timer(*args)

def setflowctrl(*args):
  """setflowctrl(struct ftdi_context ftdi, int flowctrl) -> int"""
  return _ftdi1.setflowctrl(*args)

def setdtr_rts(*args):
  """setdtr_rts(struct ftdi_context ftdi, int dtr, int rts) -> int"""
  return _ftdi1.setdtr_rts(*args)

def setdtr(*args):
  """setdtr(struct ftdi_context ftdi, int state) -> int"""
  return _ftdi1.setdtr(*args)

def setrts(*args):
  """setrts(struct ftdi_context ftdi, int state) -> int"""
  return _ftdi1.setrts(*args)

def set_event_char(*args):
  """set_event_char(struct ftdi_context ftdi, unsigned char eventch, unsigned char enable) -> int"""
  return _ftdi1.set_event_char(*args)

def set_error_char(*args):
  """set_error_char(struct ftdi_context ftdi, unsigned char errorch, unsigned char enable) -> int"""
  return _ftdi1.set_error_char(*args)

def eeprom_initdefaults(*args):
  """
    eeprom_initdefaults(struct ftdi_context ftdi, char manufacturer, char product, 
        char serial) -> int
    """
  return _ftdi1.eeprom_initdefaults(*args)

def eeprom_build(*args):
  """eeprom_build(struct ftdi_context ftdi) -> int"""
  return _ftdi1.eeprom_build(*args)

def eeprom_decode(*args):
  """eeprom_decode(struct ftdi_context ftdi, int verbose) -> int"""
  return _ftdi1.eeprom_decode(*args)

def set_eeprom_value(*args):
  """
    set_eeprom_value(struct ftdi_context ftdi, enum ftdi_eeprom_value value_name, 
        int value) -> int
    """
  return _ftdi1.set_eeprom_value(*args)

def set_eeprom_buf(*args):
  """set_eeprom_buf(struct ftdi_context ftdi, unsigned char buf, int size) -> int"""
...
def write_eeprom(*args):
  """write_eeprom(struct ftdi_context ftdi) -> int"""
  return _ftdi1.write_eeprom(*args)

def erase_eeprom(*args):
  """erase_eeprom(struct ftdi_context ftdi) -> int"""
  return _ftdi1.erase_eeprom(*args)

def write_eeprom_location(*args):
  """write_eeprom_location(struct ftdi_context ftdi, int eeprom_addr, unsigned short eeprom_val) -> int"""
  return _ftdi1.write_eeprom_location(*args)

def get_error_string(*args):
  """get_error_string(struct ftdi_context ftdi) -> char"""
