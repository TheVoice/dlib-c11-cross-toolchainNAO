...
#define __GMP_CC "i686-pc-linux-gnu-gcc -std=gnu99"
#define __GMP_CFLAGS " -g -ggdb -gdwarf-2 -O2 -m32 -mtune=atom -fomit-frame-pointer -pipe -mssse3 -mfpmath=sse -DI_AM_A_ROBOT"
